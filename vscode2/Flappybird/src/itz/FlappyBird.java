    ...
    public void move() {
        ...
        for (int i = 0; i < pipes.size(); i++) {
            ...
            if (collision(bird, pipe)) {
                ...
                gameOver = true;
                JOptionPane.showMessageDialog(this, "Game Over! score: " + (int) score, "Game Over", JOptionPane.INFORMATION_MESSAGE);
    ...
    public void keyPressed(KeyEvent e) {
        if (e.getKeyCode() == KeyEvent.VK_SPACE) {
            ...
            if (gameOver) {
                ...
                velocityX = -4; 
                gameLoop.start();
                placePipeTimer.setDelay(1500); //reset pipe spawn rate to 1500ms
