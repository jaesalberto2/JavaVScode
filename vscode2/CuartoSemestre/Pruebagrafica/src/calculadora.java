...
public class calculadora {
     ...
     element11.setBounds(52, 170, 106, 28);
     element11.setFont(CustomFontLoader.loadFont("./resources/fonts/Lato.ttf", 14));
     element11.setBackground(Color.decode("#ffffff"));
     element11.setForeground(Color.decode("#000000"));
     element11.setBorder(new RoundedBorder(2, Color.decode("#979797"), 0));
     OnFocusEventHelper.setOnFocusText(element11, "", Color.decode("#353535"),   Color.decode("#656565"));
     panel.add(element11);

     JButton borrar = new JButton("borrar");
     borrar.setBounds(52, 204, 106, 28);
     borrar.setBackground(Color.decode("#2e2e2e"));
     borrar.setForeground(Color.decode("#D9D9D9"));
     borrar.setFont(CustomFontLoader.loadFont("./resources/fonts/Lato.ttf", 14));
     borrar.setForeground(Color.decode("#D9D9D9"));
     panel.add(borrar);
     ...
     b1.addActionListener(e -> element11.setText(element11.getText() + "1"));
     b2.addActionListener(e -> element11.setText(element11.getText() + "2"));
     b3.addActionListener(e -> element11.setText(element11.getText() + "3"));
     b4.addActionListener(e -> element11.setText(element11.getText() + "4"));
     b5.addActionListener(e -> element11.setText(element11.getText() + "5"));
     b6.addActionListener(e -> element11.setText(element11.getText() + "6"));
     b7.addActionListener(e -> element11.setText(element11.getText() + "7"));
     b8.addActionListener(e -> element11.setText(element11.getText() + "8"));
     b9.addActionListener(e -> element11.setText(element11.getText() + "9"));
     b0.addActionListener(e -> element11.setText(element11.getText() + "0"));
     suma.addActionListener(e -> element11.setText(element11.getText() + "+"));
     resta.addActionListener(e -> element11.setText(element11.getText() + "-"));
     multiplicacion.addActionListener(e -> element11.setText(element11.getText() + "x"));
     division.addActionListener(e -> element11.setText(element11.getText() + "/"));
     igual.addActionListener(e -> calculate(element11));
     borrar.addActionListener(e -> element11.setText(""));
...
private void calculate(JTextField element11) {
     ...
     if (text.contains("+")) {
         ...
         element11.setText(Integer.toString(result));
     ...
     // resetear el texto si no se cumple ninguna condición
     else {
         element11.setText("");
     }
